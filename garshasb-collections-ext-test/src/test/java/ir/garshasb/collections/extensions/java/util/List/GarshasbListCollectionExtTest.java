package ir.garshasb.collections.extensions.java.util.List;

import manifold.test.api.ExtensionManifoldTest;
import java.util.*;
public class GarshasbListCollectionExtTest extends ExtensionManifoldTest {
    @Override
    public void testCoverage() {
        testCoverage(GarshasbListCollectionExt.class);
    }
