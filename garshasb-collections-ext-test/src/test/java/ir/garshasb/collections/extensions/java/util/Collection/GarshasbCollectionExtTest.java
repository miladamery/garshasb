package ir.garshasb.collections.extensions.java.util.Collection;

import manifold.test.api.ExtensionManifoldTest;
import java.util.*;
import java.util.stream.Collectors;

public class GarshasbCollectionExtTest extends ExtensionManifoldTest {
    @Override
    public void testCoverage() {
        testCoverage(GarshasbCollectionExt.class);
    }
