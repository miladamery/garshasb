...
public class GarshasbIterableExtTest extends ExtensionManifoldTest {
    public void testCoverage() {
        //testCoverage(GarshasbIterableExt.class);
    }
    ...
    public void testPlusIterable() {
        ...
        assertThat(l1 + l2).hasSameElementsAs(Arrays.asList("1", "2", "3", "4", "5", "6"));
    }

    public void testPlusElement() {
        List<String> l1 = new ArrayList<>(Arrays.asList("1", "2", "3"));
        assertThat(l1 + "4").hasSameElementsAs(Arrays.asList("1", "2", "3", "4"));
    }

    public void testPlusArray() {
        List<String> l1 = new ArrayList<>(Arrays.asList("1", "2", "3"));
        String[] strArr = new String[]{"4", "5", "6"};
        assertThat(l1 + strArr).hasSameElementsAs(Arrays.asList("1", "2", "3", "4", "5", "6"));
    }

    public void testMinusArray() {
        List<String> l1 = Arrays.asList("1", "2", "3", "4", "5", "6");
        String[] l2 = new String[]{"1", "2", "6"};
        assertThat(l1 - l2).hasSameElementsAs(Arrays.asList("3", "4", "5"));
    }

    public void testMinusIterable() {
        List<String> l1 = Arrays.asList("1", "2", "3", "4", "5", "6");
        List<String> l2 = Arrays.asList("1", "2", "6");
        assertThat(l1 - l2).hasSameElementsAs(Arrays.asList("3", "4", "5"));
        assertThat(l2 - l1).hasSameElementsAs(Collections.emptyList());
    }

    public void testAssociateIterableWithTransformFunction() {
        List<String> l1 = Arrays.asList("milad", "moen", "robab", "pouria", "simin", "sorosh");
        ...
        assertThat(l1.associate(str -> new Pair<String, Integer>(str, str.length())))
                .containsExactlyInAnyOrderEntriesOf(res);
    }
